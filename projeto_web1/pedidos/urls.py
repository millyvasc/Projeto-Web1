...
urlpatterns = [
    ...
    path("<int:mesa1>/carrinhoRemover/<int:cod_produto>/", views.remover_carrinho_confirmar, name="remover_carrinho_confirmar"),
    path("<int:mesa1>/confirmarPedidoFinal/<int:cod_pedido>/", views.confirmarPedidoFinal, name="confirmarPedidoFinal"),
